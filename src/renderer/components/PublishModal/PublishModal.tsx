    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '18px 20px 14px', borderBottom: '1px solid var(--border, #e0e0e0)' }}>
          ...
          <div style={{ fontSize: 11, color: 'var(--ink-3, #888)', marginTop: 3 }}>
            {phase === 'loading' && 'Computing diff…'}
            {phase === 'review' && 'Review changes before publishing'}
            {phase === 'publishing' && 'Uploading to Google Drive…'}
            {phase === 'done' && 'Published successfully'}
